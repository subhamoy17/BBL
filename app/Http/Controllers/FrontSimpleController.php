...
public function index(Request $request)
  ...
  return view('bbl')->with(compact('bootcamp_product_details','personal_training_product_details','all_product_details'));
  }
      catch(\Exception $e) 
      {
        return abort(400);
...
public function frontprice(Request $request)
{
  ...
  return view('frontpricing')->with(compact('data','personal_training_product_details','bootcamp_product_details','gym_product_details','all_product_details'));
