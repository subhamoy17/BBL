...
<div class="banner_top">
		<div class="slider">
			<div class="wrapper">
				...
				<!-- Slideshow 3 Pager -->
				<ul id="slider3-pager">
					<li><a href="#"><img src="<?php echo e(asset('frontend/images/banner11.jpg')); ?>" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="<?php echo e(asset('frontend/images/banner22.jpg')); ?>" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="<?php echo e(asset('frontend/images/banner33.jpg')); ?>" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="<?php echo e(asset('frontend/images/banner44.jpg')); ?>" data-selector="img" alt=""></a></li>
					...
					<ul class="about-list">
						<li>
							<div class="col-md-4 we-gyl">
								<img src="<?php echo e(asset('frontend/images/1.jpg')); ?>" alt="" class="img-responsive" />
							</div>
						...
						<li>
						<div class="col-md-4 we-gyl">
								<img src="<?php echo e(asset('frontend/images/2.jpg')); ?>" alt="" class="img-responsive" />
							</div>
							<div class="col-md-8 in-block">
								<h5>BOOT CAMP</h5>
								<p>Suspendisse maximus leo vel facilisis porta. Aliquam posuere mollis auctor. Nunc eget massa eleifend, finibus.</p>
						...
						<li>
							<div class="col-md-4 we-gyl">
								<img src="<?php echo e(asset('frontend/images/3.jpg')); ?>" alt="" class="img-responsive" />
							</div>
							<div class="col-md-8 in-block">
								<h5>CROSSFIT</h5>
								<p>Suspendisse maximus leo vel facilisis porta. Aliquam posuere mollis auctor. Nunc eget massa eleifend, finibus.</p>
    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    				<div class="box-hover-effect thumb-cross-effect forservice">
    					<div class="effect-wrapper">
    						<div class="thumb"><img src="<?php echo e(asset('frontend/images/sr1.jpg')); ?>"></div>
    			...
    			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    				<div class="box-hover-effect thumb-cross-effect forservice">
    					<div class="effect-wrapper">
    						<div class="thumb"><img src="<?php echo e(asset('frontend/images/sr2.jpg')); ?>"></div>
    						<a class="hover-link">View more</a>
    					</div>
    					<div class="sr-text">
    						<h4>Lorem Ipsum</h4>
    			...
    			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    				<div class="box-hover-effect thumb-cross-effect forservice">
    					<div class="effect-wrapper">
    						<div class="thumb"><img src="<?php echo e(asset('frontend/images/sr3.jpg')); ?>"></div>
    						<a class="hover-link">View more</a>
    					</div>
    					<div class="sr-text">
    						<h4>Lorem Ipsum</h4>
              ...
              <div class="price-box">
                ...
                <div class="p-box-bdy">
                  ...
                  <a href="<?php echo e(url('customer/purchase_form')); ?>/<?php echo e($mydata->id); ?>" class="sign-btn2">Subscribe</a>
                   ...
                   <?php else: ?>
                <a href="<?php echo e(url('customer-login')); ?>" class="sign-btn2">Sign Up</a>
                <?php endif; ?>
...
<?php echo $__env->make('frontcustomerlayout.main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>