...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(url('/images/icon-fav.png')); ?>" type="image/x-icon">
</head>
...
<table style="width:100%">
  <tr>
    <th>Url:</th>
    <th> <a href="<?php echo e(URL::to('register/verify/'.$confirmation_code)); ?>">Click Here </a>to verify and login your account or to verify your account you can using social login by same email id </th> 
     </tr>
