...
<head>
  <title>Opps!! | 404 - Bad Request</title>
  <!-- custom-theme -->
...
<div class="container">
  ...
  <div class="gif" align="center"><img src="{{url('frontend/images/400.png')}}">
      <p class="nt-fnd-text text-center">
        <h3 align="center">Oops!!! Something went wrong.</h3>
        <h3 align="center">Please logout, then login and try again or Back to <a href="{{url('/')}}"> Homepage </a></h3>
