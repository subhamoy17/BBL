  ...
  <div class="inner-padding">
    <div class="container">
      ...
      <ul class="tabs">
        ...
        <li class="{{ Request::segment(2) === 'mybooking' ? 'active' : null  || Request::segment(2) === 'my-pt-booking' ? 'active' : null}}" rel="tab1"><a href="{{url('customer/mybooking')}}"><i class="fa fa-check"></i> My Booking</a></li>
