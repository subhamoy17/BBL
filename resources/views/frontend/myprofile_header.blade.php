  ...
  <div class="inner-padding">
    <div class="container">
      ...
      <ul class="tabs">
        ...
        <li class="{{ Request::segment(2) === 'profile' ? 'active' : null || Request::segment(2) === 'editprofile' ? 'active' : null}}" rel="tab3"><a href="{{url('customer/profile')}}"><i class="fa fa-check"></i>Profile</a></li>
