  ...
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #eae6e6;">
    ...
    <p align="left">Hello {{$name}},<br><br>
     ...
     @if($status=='Cancelled by customer')
        Your payment is not successfully complete. Because this payment is cancelled by you.<br>
      @endif
      @if($status=='Payment success')
        Thank you for your purchasing this diet plan. Please download the below attachment pdf file.<br>
      @endif
