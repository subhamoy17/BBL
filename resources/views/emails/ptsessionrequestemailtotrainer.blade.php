...
<body style="margin: 0; padding: 0;">
  <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #eae6e6;">
    ...
    <p align="left">
      Hello {{$trainer_name}},
      <br><br>
      @if($status=='Cancelled PT Session By Admin To Trainer')
        One booking session is cancelled by @if($trainer_id==Auth::user()->id) you.@else {{Auth::user()->name}}.@endif Please see the below details of cancelled session.<br>
      ...
      <br>
      <a href="{{URL::to($url)}}" style="text-decoration: none;font-size: 13px;font-family: 'Open Sans', sans-serif;background: #fb5b21;padding: 12px;display: inline-block;color: #fff;border-radius: 5px;font-weight: 600; text-transform: capitalize;"><i class="fas fa-check" style="margin-right:3px;"></i> Click to check deleted schedule</a>

      @elseif($status=='Book PT Session By Admin To Trainer')
        One personal training session is booked by @if($trainer_id==Auth::user()->id) you.@else {{Auth::user()->name}}.@endif Please see the below details of booking schedule.<br>
      ...
      <br>
      <a href="{{URL::to($url)}}" style="text-decoration: none;font-size: 13px;font-family: 'Open Sans', sans-serif;background: #fb5b21;padding: 12px;display: inline-block;color: #fff;border-radius: 5px;font-weight: 600; text-transform: capitalize;"><i class="fas fa-check" style="margin-right:3px;"></i> Click to check booked schedule</a>
    @endif
