...
<body class="lg-body">
    ...
    <div class="logo-m"><img src="{{asset('frontend/images/logo.png')}}"></div>
            ...
            <div class="container-fluid">
                    ...
                    <form action="{{route('customer-register-success')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" id="myregistration">
                        ...
                        <div class="input-box">
                            ...
                            name="name" value="" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                          
                            <input class="yr-email" placeholder="Email"  id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" >
                                @if ($errors->has('email'))
