        ...
        <div class="exr-box">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 exr-txt">
            <div class="exr-emg">
              ...
              <h5><span>Duration</span> {{$mydata->duration}} hrs.</h5>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="exr-emg">
              <iframe width="100%" height="315" src="{{$mydata->video}}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
