...
@extends('trainerlayouts.trainer_first_login_template')

@section('content')

<!-- validation of new password and new password confirmation for change password -->
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ route('trainer.firstchangepassword.update') }}" id="changepassword">
                        @csrf

                        <input id="email" type="hidden" class="form-control" name="email" value="{{$trainer_details->email}}">

                        <input id="name" type="hidden" class="form-control" name="name" value="{{$trainer_details->name}}">
