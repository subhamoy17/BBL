...
<div class="col-lg-12">
  <div class="card">
    <div class="card-body card-block">
      <form action="{{route('motedit')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="motaddform">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="right_arm" name="right_arm" placeholder="Right Arm" class="form-control" value="{{$data->right_arm}}">
    ...
    <div class="row form-group">
      ...
      <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="left_arm" name="left_arm" placeholder="Left Arm" class="form-control" value="{{$data->left_arm}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="chest" name="chest" placeholder="Chest" class="form-control" value="{{$data->chest}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="waist" name="waist" placeholder="Waist" class="form-control" value="{{$data->waist}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="hips" name="hips" placeholder="Hips" class="form-control" value="{{$data->hips}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="right_thigh" name="right_thigh" placeholder="Right thigh" class="form-control" value="{{$data->right_thigh}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="left_thigh" name="left_thigh" placeholder="Left thigh" class="form-control" value="{{$data->left_thigh}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="right_calf" name="right_calf" placeholder="Right Calf" class="form-control" value="{{$data->right_calf}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="left_calf" name="left_calf" placeholder="Left Calf" class="form-control" value="{{$data->left_calf}}">
...
<div class="row form-group">
  ...
  <div class="col-md-9"><div class="row"><div class="col-lg-6"><input type="text" id="height" name="height" placeholder="Height" class="form-control" value="{{$data->height}}">
