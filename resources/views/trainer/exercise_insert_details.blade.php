  ...
  function  add_exercise_fun(){ 
   ...
   var regExp = /^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=|\?v=)([^#\&\?]*).*/;
    ...
    { 
      ...
      $.post("{{url('trainer/cheeckexercisecategory')}}",$('#traineraddform').serialize(), function(data){
            if(data==1)
            { 
              $('.btn-primary').attr('disabled','disabled');
    ...
    <div class="card-body card-block">
      <form action="{{route('exercise_insert')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="traineraddform"  data-parsley-validate>
        ...
        <div class="row form-group">
          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Category<span class="required_field_color">*</span></label>
          </div>
          <div class="col-12 col-md-9"><input type="text" id="title" name="title" placeholder="Category" class="form-control" onkeyup=" return add_exercise_fun()">
            <div id="duplicate_category"></div>
        ...
        <div class="row form-group">
          <div class="col col-md-3">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9"><input type="text" id="video" name="video" placeholder="Video Link" class="form-control"  onkeyup="return add_exercise_fun()">
