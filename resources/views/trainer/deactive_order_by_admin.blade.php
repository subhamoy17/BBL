...
<div class="content mt-3" style="margin-top: 0px !important;">
  <div class="animated fadeIn">
    ...
    <div class="col-sm-8">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>Choose date to de-active order</h1>
            </div>
        </div>
    </div>
    
</div>
      <form  action="{{route('deactive_order_success')}}" class="slct-margin" id="submit_bootcamp_session" method="post" autocomplete="off">
          {{ csrf_field() }}
        ...
        <div class="row form-group">
          ...
          <div class="col-lg-3">
            <button name="bootcamp_session_submit" id="bootcamp_session_submit" class="btn btn-primary pull-right" style="width: 100px;">De-active</button>
          </div>
        </div>
      </form>
                </div>
